...
namespace Persistence.Migrations
{
    ...
    [Migration("20260920074028_PrescriptionAndMedicineModels")]
    partial class PrescriptionAndMedicineModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DoctorTimeOff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.DoctorWorkingHour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.MedicalRecord", b =>
                {
                    ...
                    b.OwnsOne("Domain.Entities.VitalSigns", "VitalSigns", b1 =>
                        {
                            ...
                            b1.Property<int?>("BloodPressureDiastolic")
                                .HasColumnType("int")
                                .HasColumnName("VitalSigns_BpDiastolic");

                            b1.Property<int?>("BloodPressureSystolic")
                                .HasColumnType("int")
                                .HasColumnName("VitalSigns_BpSystolic");

                            b1.Property<int?>("HeartRate")
                                .HasColumnType("int")
                                .HasColumnName("VitalSigns_HeartRate");

                            b1.Property<decimal?>("Temperature")
                                .HasPrecision(4, 1)
                                .HasColumnType("decimal(4,1)")
                                .HasColumnName("VitalSigns_Temperature");

                            b1.Property<decimal?>("WeightKg")
                                .HasPrecision(5, 2)
                                .HasColumnType("decimal(5,2)")
                                .HasColumnName("VitalSigns_WeightKg");
